...
get_header(); ?>
    ...
    <main class="site-main">
        ...
        <!--  ======================= Start Banner Area =======================  -->
        <section class="site-banner" style="background-image: url(<?php bloginfo('stylesheet_directory'); ?>/images/home-banner.png) ">

            <div id="clouds" style="background-image: url(<?php bloginfo('stylesheet_directory'); ?>/images/clouds.png);"></div>

            <div class="container">  

                <?php $index_query = new WP_Query(array( 'post_type' => 'home_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>

                <div class="row">
                    <div class="col-lg-6 col-md-12 site-title">
                        <?php the_content(); ?>
                        <div class="site-buttons wow fadeInDown" data-wow-delay="2s">
                            <div class="d-flex flex-row flex-wrap">
                                <button type="button" class="custom-btn" data-toggle="modal" data-target=".hireMeModal">hire me</button>
                                <a href="<?php echo the_field('get-cv-link'); ?>" class="custom-btn3" target="_blank">Get CV</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 banner-image wow fadeInRight" data-wow-duration="2s">
                        <!-- <img src="<?php //bloginfo('stylesheet_directory'); ?>/images/banner-image.png" alt="banner-img" class="img-fluid"> -->

                        <svg id="59725d3d-bdd8-4af0-9b66-49b8d09410bc" width="1041.32" height="554.17" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1041.32 554.17">
                            <title>Ebraiz</title>
                            ...
                            <g opacity="0.1">
                                <path d="M242.24,217V726.62l-42.33.46a88.07,88.07,0,0,1-26.67-3.82V279h.07C194.1,253.45,217.41,232.13,242.24,217Z" transform="translate(-79.34 -172.91)" fill="#6c63ff" />
                                <path d="M1117.24,290.08H164.6q4.25-5.64,8.64-11V279h941.63Q1116.24,284.43,1117.24,290.08Z" transform="translate(-79.34 -172.91)" fill="#6c63ff" />
                                ...
                                <path d="M1037.35,618.52q-2.7,5.67-5.33,11.12H93.85q-1.93-5.49-3.6-11.12Z" transform="translate(-79.34 -172.91)" fill="#6c63ff" />
                            </g>
                            ...
                            <polygon points="175.93 99.16 156.6 250.49 324.6 255.82 345.26 109.82 175.93 99.16" fill="#6c63ff" />
                            ...
                            <polygon points="628.93 103.16 798.6 94.82 812.93 246.82 644.6 250.82 628.93 103.16" fill="#6c63ff" />
                            ...
                            <path d="M623,535.65c-29,5.34-83.6,4.19-107.2,3.38,8.65-31,50.83-20.46,50.83-20.46C618.84,508.15,622.84,529.77,623,535.65Z" transform="translate(-79.34 -172.91)" fill="#6c63ff" />
                            ...
                            <line x1="198.99" y1="342.86" x2="300.6" y2="341.86" fill="none" stroke="#6c63ff" stroke-miterlimit="10" stroke-width="2" />
                            <line x1="198.99" y1="355.33" x2="300.6" y2="354.34" fill="none" stroke="#6c63ff" stroke-miterlimit="10" stroke-width="2" />
                            <line x1="198.99" y1="367.81" x2="300.6" y2="366.81" fill="none" stroke="#6c63ff" stroke-miterlimit="10" stroke-width="2" />
                        </svg>
                    </div>
                </div>
        ...
        <section id="about">
            <div class="about-area">
                <div class="container">
                    <div class="row">
                    <?php $index_query = new WP_Query(array( 'post_type' => 'about_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                    <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>

                        <div class="col-lg-6 col-md-12 wow fadeInLeft" data-wow-duration="2s">
                            <div class="about-image">
                                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/about-us.png" alt="About us" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-12 about-title wow fadeInRight" data-wow-duration="2s">
                            <h2 class="text-uppercase wow fadeUp" data-wow-duration="2s">
                                <span><?php the_title(); ?></span>
                            </h2>
                            <div class="paragraph">
                                <?php the_content(); ?>
                            </div>
                            <a href="<?php the_field('upload_cv'); ?>" class="custom-btn2">Download CV</a>
                        </div>
        ...
        <section id="skills">
            <div class="skills-area">
                <div class="container">
                    ...
                    <div class="row wow fadeUp" data-wow-duration="2s">
                        <div class="col-lg-12 experience-title">
                            <h2 class="title-text"><?php echo $options['skillssectiontitle']; ?></h2>
                            <p><?php echo $options['skillssectiondescription']; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="first-row row">
                                ...
                                <?php $index_query = new WP_Query(array( 'post_type' => 'skills_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                                <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>

                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="single-brand wow flipInY" data-wow-duration="4s" data-wow-delay="1s">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12 wow fadeInRight" data-wow-duration="2s">
                            <div class="experience-area" id="experience-area">
                                <div class="d-flex flex-row years-area" style="background-image:url(<?php bloginfo('stylesheet_directory'); ?>/images/client-info-bg.png) ">
                                    <h2 class="p-3 years"><?php echo $options['noofexperience']; ?></h2>
                                    <h2>
                                        <span>Years</span>
                                ...
                                <div class="d-flex flex-row flex-wrap call-area">
                                    ...
                                    <div class="call-now">
                                        <h3>Call Now</h3>
                                        <span class="font-roboto py-2"><?php echo $options['phone']; ?></span>
                                    </div>
                                </div>
        ...
        <section id="experience">
            <div class="experience-area">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12 experience-title wow fadeInUp" data-wow-duration="1s">
                            <h2 class="title-text"><?php echo $options['experiencesectiontitle']; ?></h2>
                            <p><?php echo $options['experiencesectiondescription']; ?></p>
                        </div>
                    </div>
                    <div class="services-list">
                        <div class="experience-slider">
                            
                            <?php $index_query = new WP_Query(array( 'post_type' => 'experience_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                            <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>

                                <div class="experience-box wow zoomIn" data-wow-duration="1s">
                                    <div class="experience-item">
                                        <div class="experience">
                                            <div class="sevices-img py-2">
                                                <?php the_post_thumbnail('full', ['class' => 'img-fluid']); ?>
                                            </div>
                                            <div class="card-body text-center">
                                                ...
                                                <h5 class="card-sub-title font-roboto">
                                                    <?php the_field('company_designation'); ?>
                                                </h5>
                                                <?php the_content(); ?> 
                                                <a href="<?php the_field('company_website'); ?>" class="custom-btn2">visit website</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="project-title pb-3 wow fadeInUp" data-wow-duration="2s">
                                <h2 class="title-text">
                                    <?php echo $options['projectssectiontitle']; ?>
                                </h2>
                            </div>

                            <div class="project-categories filter-button-group">
                                <ul>
                                    <li class="active" data-filter="*">All</li>

                                    <?php

                                    $states = $wpdb->get_results("SELECT DISTINCT meta_value FROM wp_postmeta WHERE meta_key='project_category'");

                                    foreach ($states as $value) :

                                        $category_name = strtolower(trim($value->meta_value));
                                        $removebrackets = preg_replace('/\s*\([^)]*\)/', '', $category_name);
                                        $slug = preg_replace('/[^A-Za-z0-9\-]/', '-', $removebrackets);
                                        ?>

                                        <li data-filter='.<?php echo $slug; ?>'>
                            ...
                            <div class="grid">
                                <?php $index_query = new WP_Query(array( 'post_type' => 'project_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                                <?php while ($index_query->have_posts()) : $index_query->the_post();

                                    $str = strtolower(trim(get_field('project_category')));
                                    $removebrackets = preg_replace('/\s*\([^)]*\)/', '', $str);
                                    $slug = preg_replace('/[^A-Za-z0-9\-]/', '-', $removebrackets);
                                ?>

                                <div class="<?php echo $slug; ?> grid-item">
                                    <div class="our-project">
                                        <div class="img">
                                            <div class="portfolio-slider">
                                                ...
                                                <img src="<?php the_sub_field('gallery_images'); ?>" alt="portfolio-1" class="img-fluid" />
                                                ...
                                                <div class="col-sm-8 col-7">
                                                    <div class="title">
                                                        ...
                                                        <span class="text-secondary">
                                                            <b>
                                                                <?php the_field('project_category'); ?></b>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4 col-5 text-right">
                                                    <div class="manage-web-icon">
                                                        <a href="<?php the_field('project_website_link'); ?>">
                                                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/web-icon.png" title="Visit Website" class="img-fluid" alt="img" />
                                                        </a>
                                                    </div>
                                                    <div class="manage-git-icon">
                                                        <a href="<?php the_field('project_github_link'); ?>">
                                                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/github.png" title="Visit Github" class="img-fluid" alt="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col project-sub-text">
        ...
        <section id="qualification">
            <div class="education-area">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center education-title wow fadeInUp" data-wow-duration="2s">
                            <h2 class="title-text"><?php echo $options['educationsectiontitle']; ?></h2>
                            <p><?php echo $options['educationsectiondescription']; ?></p>
                        </div>
                    </div>
                    <div class="education-list">
                        <div class="education-slider">

                            <?php $index_query = new WP_Query(array( 'post_type' => 'education_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                            <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>
                        
                                <div class="education wow zoomIn" data-wow-duration="1s">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-sub-title font-roboto">
                                            <?php the_field('education_level'); ?>
                                        </h5>
                                        <?php the_content('description'); ?>
                                        <a href="<?php the_field('institute_url'); ?>" class="custom-btn2">visit website</a>
                                    </div>
                                </div>
        ...
        <section id="blog">
            <div class="blog-area">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col">
                            <div class="section9-heading text-center wow fadeInUp" data-wow-duration="2s">
                                <h2 class="title-text"><?php echo $options['blogsectiontitle']; ?></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="blog-box wow zoomIn" data-wow-duration="1s">
                                ...
                                <div class="blog-box-content">
                                    ...
                                    <p><?php the_title(); ?></p>
                                    <?php the_excerpt(); ?> 
                                    <a href="<?php the_permalink(); ?>" class="custom-btn2">Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="text-center">
                                <a href="<?php echo site_url(''); ?>/blog" class="custom-btn2">view more</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="about-area">
                ...
                <div class="container">
                    <div class="row text-center mb-3">
                        <div class="col-12">
                            <div class="about-title wow fadeInUp" data-wow-duration="2s">
                                <h2 class="title-text"><?php echo $options['seminarsectiontitle']; ?></h2>
                                <p><?php echo $options['seminarsectiondescription']; ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <?php $index_query = new WP_Query(array( 'post_type' => 'seminar_section', 'posts_per_page' => -1,'order'=>'DESC' )); ?>
                            <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>

                              <div class="client wow zoomIn" data-wow-duration="1s">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-2 col-md-2 col-sm-2 col-3">
                                              <div class="seminar-date">
                                                  <p><?php the_field('seminar_month'); ?></p>
                                                  <p><?php the_field('seminar_day'); ?></p>
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-lg-4 col-md-4 col-sm-4 d-none d-sm-block">
                                              <div class="text-center">
                                                  <a data-fancybox="gallery" class="custom-btn4" href="<?php the_field('certificate_image'); ?>">View Certificate</a>
                                              </div>
                                          </div>
                                        </div>
                                    </div>
